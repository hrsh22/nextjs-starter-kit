...
- Pricing page (`/pricing`) with static plans (no payments)
- Dashboard pages with CRUD operations on users/teams
- Basic RBAC with Owner and Member roles
- Subscription section in dashboard (no billing)
...
No webhook listeners are needed.

## Payments

Payments are not included in this starter. Integrate your preferred provider if needed.

## Going to Production

When you're ready to deploy your SaaS application to production, follow these steps:

### Add your own payments (optional)
